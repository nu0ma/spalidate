...
func InitFixtures(project, instance, database string) error {
	...
	fixtures, err = testfixtures.New(
		...
		testfixtures.Files(
			"testdata/fixtures/data/users.yml",         // Parent table first
			"testdata/fixtures/data/products.yml",      // Independent table
			"testdata/fixtures/data/orders.yml",        // Child table (interleaved with Users)
			"testdata/fixtures/data/json_test_table.yml", // JSON test table
		),
	)
	if err != nil {
